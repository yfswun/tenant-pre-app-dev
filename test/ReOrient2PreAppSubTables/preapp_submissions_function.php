...
function get_preapp_submissions() {
	...
	echo '<h2 class="TPASubForm contact">Applicant Contact</h2>';
	echo '<div class="TPATableWrapper contact">';
		echo '<table class="TPATable FullWidthCenter">';
			echo '<tr class="TPARow">';
				echo '<th class="TPACell">First Name</th>';
				echo '<td class="AlignCenter TPACell" id="first_name">' . esc_html( $applicantInfo["FirstName"] ) . '</td>';
			echo '</tr>';
			echo '<tr class="TPARow">';
				echo '<th class="TPACell">Last Name</th>';
				echo '<td class="AlignCenter TPACell" id="last_name">' . esc_html( $applicantInfo["LastName"] ) . '</td>';
			echo '</tr>';
			echo '<tr class="TPARow">';
				echo '<th class="TPACell">Email</th>';
				echo '<td class="AlignCenter TPACell" id="email_add">' . esc_html( $applicantInfo["Email"] ) . '</td>';
			echo '</tr>';
			echo '<tr class="TPARow">';
				echo '<th class="TPACell">Phone</th>';
				...
				echo '<td class="AlignCenter TPACell" id="phone_no">' . $phone . '</td>';
			echo '</tr>';
		echo '</table>';
	echo '</div>';

	echo '<h2 class="TPASubForm household">Household Information</h2>';
	echo '<div class="TPATableWrapper household">';
		echo '<table class="TPATable FullWidthCenter">';
			echo '<tr class="TPARow">';
				echo '<th class="TPACell">Household Size</th>';
				echo '<td class="AlignCenter TPACell">' . esc_html( $applicantInfo["HouseholdSize"] ) . '</td>';
			echo '</tr>';
			echo '<tr class="TPARow">';
				echo '<th class="TPACell">Annual Gross Income</th>';
				echo '<td class="AlignCenter TPACell">' . esc_html( '$ ' . number_format( $applicantInfo["AnnualGrossIncome"], 2 ) ) . '</td>';
			echo '</tr>';
			echo '<tr class="TPARow">';
				echo '<th class="TPACell">Annual Asset Amount</th>';
				echo '<td class="AlignCenter TPACell">' . esc_html( '$ ' . number_format( $applicantInfo["AnnualAssetAmt"], 2 ) ) . '</td>';
			echo '</tr>';
			echo '<tr class="TPARow">';
				echo '<th class="TPACell">Total Annual Income</th>';
				echo '<td class="AlignCenter TPACell">' . esc_html( '$ ' . number_format( $applicantInfo["TotalAnnualIncome"], 2 ) ) . '</td>';
			echo '</tr>';
		echo '</table>';
	echo '</div>';
