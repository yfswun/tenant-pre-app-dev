<?php
/**
 * The template used for displaying a Building page content
 *
 * @package WordPress
 * @subpackage sgwindow
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-content">
			<?php
				...
				// Begin: 09/18/15 Sylvia Wun
				$slug = basename(get_permalink());
				set_query_var( 'bldg_slug', $slug);
				get_template_part('templates/content', 'building-specs');
				// End  : 09/18/15 Sylvia Wun
